...
export function IconEyeOff({ size = 14 }: IconProps) {
  return (
    <svg
      ...
      strokeLinejoin="round"
    >
      <path d="M10.7 5.1A10.7 10.7 0 0 1 12 5c6.5 0 10 7 10 7a17.5 17.5 0 0 1-2.2 3.2M6.6 6.6C3.8 8.5 2 12 2 12s3.5 7 10 7c1.7 0 3.2-.5 4.4-1.2" />
...
export function IconDiscord({ size = 14 }: IconProps) {
  return (
    <svg
      aria-hidden="true"
      viewBox="0 0 24 24"
...
export function IconReply({ size = 14 }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M20 4v6a4 4 0 0 1-4 4H4" />
    </svg>
  );
}
